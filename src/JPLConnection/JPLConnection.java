...
public class JPLConnection {
    //prolog file name
    private final String PROLOG_FILE = "RulesForQuickSort.pl";
    ...
    public Term sortingQuery(String queryText) throws Exception{
    ...
    public LinkedHashMap<String, Term> convertSortingResultToMap
        (Term term, LinkedHashMap<String,Term> sortedResultMap)throws Exception{
