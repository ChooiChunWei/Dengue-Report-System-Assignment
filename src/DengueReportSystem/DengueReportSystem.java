...
public class DengueReportSystem {
    ...
    private static final String FIRST_FILE_PATH = 
            "./src/xlxs Files/statistik-kes-denggi-di-negeri-pahang-bagi-tempoh-2014-2017.xlsx";
    private static final String SECOND_FILE_PATH = 
            "./src/xlxs Files/statistik-kes-denggi-di-negeri-pahang-bagi-tempoh-2018-2019.xlsx";
